  ...
  const askExpert = async () => {
    ...
    try {
      ...
      const result = await ai.models.generateContent({
        ...
        contents: query,
        config: {
          systemInstruction: 'Você é o Especialista em Automação da 6ESSH. Seu objetivo é explicar como as 50 automações financeiras e imobiliárias apresentadas no site podem ajudar o usuário. Seja profissional, institucional e conciso. Responda em Português do Brasil.',
        }
      });
          ...
          <div className="p-4 h-64 md:h-80 overflow-y-auto custom-scrollbar bg-slate-50 dark:bg-slate-900/50" ref={chatRef}>
            {response ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-center text-slate-400">
                ...
                <p className="text-xs">Olá! Eu sou a IA da 6ESSH. Como posso ajudar você a entender nossas automações hoje?</p>
              </div>
            )}
          </div>
